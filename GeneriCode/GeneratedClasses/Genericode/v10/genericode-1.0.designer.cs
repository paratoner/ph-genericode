...
namespace GeneriCode.GeneratedClasses.Genericode.v10
{
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace = "http://docs.oasis-open.org/codelist/ns/genericode/1.0/")]
    [System.Xml.Serialization.XmlRootAttribute(Namespace = "http://docs.oasis-open.org/codelist/ns/genericode/1.0/", IsNullable = true)]
    ...
    public partial class DataRestrictions
    {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(DataRestrictions));
                }
                return serializer;
            }
        }
        ...
        #region Serialize/Deserialize
        /// <summary>
        /// Serializes current DataRestrictions object into an XML document
        /// </summary>
        /// <returns>string XML value</returns>
        public virtual string Serialize(System.Text.Encoding encoding)
        {
        ...
        /// <summary>
        /// Deserializes workflow markup into an DataRestrictions object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output DataRestrictions object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out DataRestrictions obj, out System.Exception exception)
        {
            exception = null;
            obj = default(DataRestrictions);
            try
            {
                obj = Deserialize(xml);
                return true;
        ...
        public static bool Deserialize(string xml, out DataRestrictions obj)
        {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }

        public static DataRestrictions Deserialize(string xml)
        {
            System.IO.StringReader stringReader = null;
            try
            {
                stringReader = new System.IO.StringReader(xml);
                return ((DataRestrictions)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally
            {
                if ((stringReader != null))
        ...
        /// <summary>
        /// Serializes current DataRestrictions object into file
        /// </summary>
        /// <param name="fileName">full path of outupt xml file</param>
        /// <param name="exception">output Exception value if failed</param>
        /// <returns>true if can serialize and save into file; otherwise, false</returns>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an DataRestrictions object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output DataRestrictions object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out DataRestrictions obj, out System.Exception exception)
        {
            exception = null;
            obj = default(DataRestrictions);
            try
        ...
        public static bool LoadFromFile(string fileName, out DataRestrictions obj, out System.Exception exception)
        {
            return LoadFromFile(fileName, Encoding.UTF8, out obj, out exception);
        }

        public static bool LoadFromFile(string fileName, out DataRestrictions obj)
        {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }

        public static DataRestrictions LoadFromFile(string fileName)
        {
            return LoadFromFile(fileName, Encoding.UTF8);
        }

        public static DataRestrictions LoadFromFile(string fileName, System.Text.Encoding encoding)
        {
            System.IO.FileStream file = null;
            System.IO.StreamReader sr = null;
            try
    ...
    [System.SerializableAttribute()]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace = "http://docs.oasis-open.org/codelist/ns/genericode/1.0/")]
    [System.Xml.Serialization.XmlRootAttribute(Namespace = "http://docs.oasis-open.org/codelist/ns/genericode/1.0/", IsNullable = false)]
    public enum UseType
    {
    ...
    public partial class CodeListSetDocument
    {
        ...
        [System.Xml.Serialization.XmlElementAttribute("CodeListRef", typeof(CodeListRef), Form = System.Xml.Schema.XmlSchemaForm.Unqualified, Order = 2)]
        [System.Xml.Serialization.XmlElementAttribute("CodeListSet", typeof(CodeListSetDocument), Form = System.Xml.Schema.XmlSchemaForm.Unqualified, Order = 2)]
        [System.Xml.Serialization.XmlElementAttribute("CodeListSetRef", typeof(CodeListSetRef), Form = System.Xml.Schema.XmlSchemaForm.Unqualified, Order = 2)]
        public List<object> Items
        {
            get
            {
    ...
    public partial class CodeListRef
    {
        ...
        [System.Xml.Serialization.XmlElementAttribute("LocationUri", Form = System.Xml.Schema.XmlSchemaForm.Unqualified, DataType = "anyURI", Order = 3)]
        public List<string> LocationUri
        {
            get
            {
    ...
    public partial class CodeListSetRef
    {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(CodeListSetRef));
                }
                return serializer;
            }
        }
        ...
        #region Serialize/Deserialize
        /// <summary>
        /// Serializes current CodeListSetRef object into an XML document
        /// </summary>
        /// <returns>string XML value</returns>
        public virtual string Serialize(System.Text.Encoding encoding)
        {
        ...
        /// <summary>
        /// Deserializes workflow markup into an CodeListSetRef object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output CodeListSetRef object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out CodeListSetRef obj, out System.Exception exception)
        {
            exception = null;
            obj = default(CodeListSetRef);
            try
            {
                obj = Deserialize(xml);
                return true;
        ...
        public static bool Deserialize(string xml, out CodeListSetRef obj)
        {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }

        public static CodeListSetRef Deserialize(string xml)
        {
            System.IO.StringReader stringReader = null;
            try
            {
                stringReader = new System.IO.StringReader(xml);
                return ((CodeListSetRef)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally
            {
                if ((stringReader != null))
        ...
        /// <summary>
        /// Serializes current CodeListSetRef object into file
        /// </summary>
        /// <param name="fileName">full path of outupt xml file</param>
        /// <param name="exception">output Exception value if failed</param>
        /// <returns>true if can serialize and save into file; otherwise, false</returns>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an CodeListSetRef object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output CodeListSetRef object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out CodeListSetRef obj, out System.Exception exception)
        {
            exception = null;
            obj = default(CodeListSetRef);
            try
        ...
        public static bool LoadFromFile(string fileName, out CodeListSetRef obj, out System.Exception exception)
        {
            return LoadFromFile(fileName, Encoding.UTF8, out obj, out exception);
        }

        public static bool LoadFromFile(string fileName, out CodeListSetRef obj)
        {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }

        public static CodeListSetRef LoadFromFile(string fileName)
        {
            return LoadFromFile(fileName, Encoding.UTF8);
        }

        public static CodeListSetRef LoadFromFile(string fileName, System.Text.Encoding encoding)
        {
            System.IO.FileStream file = null;
            System.IO.StreamReader sr = null;
            try
